const presets = [
  ...
  {
    id: "player_love_you",
    name: "《Love you》播放器 · Плеер",
    text: `{{char}}'s Radio <br>Играет: «𝙇𝙤𝙫𝙚 𝙮𝙤𝙪» ━●──5:20<br>⇆ㅤㅤ  ㅤ◁ㅤ  ㅤ❚❚ㅤ  ㅤ▷ㅤㅤㅤ↻`,
    isBuiltIn: true,
  },
  {
    id: "pixel_blackboard",
    name: "像素小黑板 · Пиксельная доска",
  ...
  },
  {
    ...
    <div class="typing-subtitle">
        <span class="typing-text">набирает</span>
  ...
  },
  {
    ...
    name: "素笺墨韵 · Тушь и бумага",
    text: `<div class="sim-container">
    <img class="sim-background" src="https://i.imgur.com/fzQtOoh.png" alt="Paper texture">
    <div class="sim-text-wrapper" aria-label="тишь…">
        <span>т</span><span>и</span><span>ш</span><span>ь</span><span>…</span>
    </div>
  ...
  },
  {
    ...
    name: "欲语还休 · Невысказанное",
    text: `<div class="sdb-container">
    <img class="sdb-background" src="https://i.imgur.com/PWcstHJ.png" alt="Paper background with border">
    <div class="sdb-text-wrapper" aria-label="молч…">
        <span>м</span><span>о</span><span>л</span><span>ч</span><span>…</span>
    </div>
...
const BUBBLE_THEME_CSS = `.typing_indicator {
    position: relative;
...
@keyframes ti-bubble {
    0%, 100% { scale: 1; rotate: -1deg; }
    50%      { scale: 1.08; rotate: 2deg; }
}
@keyframes ti-sparkle { 0%, 100% { opacity: 0.8; scale: 1; } 50% { opacity: 1; scale: 1.4; } }
@keyframes ti-bounce { 0%, 100% { translate: 0 0; } 50% { translate: 0 -15px; rotate: 10deg; } }
@keyframes ti-glow { from { filter: drop-shadow(0 0 8px #FF69B4); } to { filter: drop-shadow(0 0 15px #FFB6C1); } }
@keyframes ti-swing { 0%, 100% { rotate: -10deg; } 50% { rotate: 10deg; } }
...
const themes = [
  {
    id: "transparent",
    name: "简约透明 · Прозрачный",
    css: TRANSPARENT_THEME_CSS,
    isBuiltIn: true,
  },
  {
    id: "soft_pink_cloud",
    name: "柔粉云朵 · Розовое облако",
  ...
  {
    id: "crystal",
    name: "冰晶 · Ледяные кристаллы (by 长青青)",
    css: CRYSTAL_THEME_CSS,
    isBuiltIn: true,
  },
  {
    id: "bubble",
    name: "Q弹泡泡 · Пузыри (by 长青青)",
    css: BUBBLE_THEME_CSS,
    isBuiltIn: true,
  },
  {
    id: "vine_green",
    name: "藤曼绿 · Лианы (by 长青青)",
  ...
  },
  {
    ...
    name: "游戏 2048",
    useIframe: true,
    html: '<div class="g2048-container">\n    <div class="g2048-header">\n        <div class="g2048-title-area">\n            <h1 class="g2048-title">2048</h1>\n            <button id="g2048-new-game-btn" class="g2048-button small">Новая игра</button>\n        </div>\n        <div class="g2048-scores">\n            <div class="g2048-score-box">\n                <span class="g2048-score-label">Счёт</span>\n                <span id="g2048-score">0</span>\n            </div>\n            <div class="g2048-score-box">\n                <span class="g2048-score-label">Рекорд</span>\n                <span id="g2048-best-score">0</span>\n            </div>\n        </div>\n    </div>\n    <div class="g2048-board-wrapper">\n        <div id="g2048-board" class="g2048-board">\n        </div>\n        <div id="g2048-game-over" class="g2048-overlay" style="display: none;">\n            <div class="g2048-menu">\n                <h2 id="g2048-menu-title">Игра окончена!</h2>\n                <div class="g2048-button-group">\n                    <button id="g2048-continue-btn" class="g2048-button" style="display: none;">Продолжить</button>\n                    <button id="g2048-restart-btn" class="g2048-button">Ещё раз</button>\n                </div>\n            </div>\n        </div>\n    </div>\n    <div class="g2048-footer">\n        <p class="g2048-instructions">Объединение блоков，Получено<strong>2048</strong>！</p>\n        <button id="g2048-undo-btn" class="g2048-button">Отмена</button>\n    </div>\n</div>',
    iframeCSS:
  ...
  },
  {
    ...
    name: "雀登梅梢 · Птица на сливе",
    useIframe: true,
    css: "",
    html: '<div class="theme-container">\n    <div class="branch">\n        <img src="https://i.imgur.com/6V5byjI.png" alt="ствол">\n    </div>\n    <div class="flowers">\n        <img src="https://i.imgur.com/ecVHk2N.png" alt="цветок">\n    </div>\n    <div class="bird">\n        <img src="https://i.imgur.com/sZ1qqTg.png" alt="птица">\n    </div>\n</div>',
    iframeCSS:
